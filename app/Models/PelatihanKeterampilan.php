...
/**
 * Class PelatihanKeterampilan
 * @package App\Models
 *
 * @OA\Schema(
 *      @OA\Xml(name="PelatihanKeterampilan"),
 *      description="PelatihanKeterampilan Model",
 *      type="object",
 *      title="PelatihanKeterampilan Model",
     *      @OA\Property(property="id", type="bigint"),
     *      @OA\Property(property="id_jenis_pelatihan_keterampilan", type="string"),
 ...
 * @property int id
     * @property bigint id
     * @property string id_jenis_pelatihan_keterampilan
