...
class RefJenisSaranaExport implements FromArray,WithCustomStartCell,ShouldAutoSize,WithTitle,WithStyles //,WithDrawings
{
    ...
    */
    ...
    public function array(): array{
        ...
        $valueSheet[] = [""];
        $valueSheet[] = ["No","Jenis Sarana","Keterangan"];

        //data

        foreach($this->data as $index => $item){
            $no = $index + 1;
            $valueSheet[] = [$no,$item['jenissarana'],$item['keterangan']];
        }
