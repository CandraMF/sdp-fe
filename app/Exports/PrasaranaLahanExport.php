<?php
			...
			class PrasaranaLahanExport implements FromArray, WithCustomStartCell, ShouldAutoSize, WithTitle, WithStyles //,WithDrawings
			{
				...
				public function array(): array
				{
					...
					foreach ($this->data as $index => $item) {
						$no = $index + 1;
						$valueSheet[] = [$no, $item['jenis_prasarana'], $item['nama_prasarana_lahan'], $item['nmupt'], $item['tgl_pengadaan'], $item['keterangan'], $item['update_terakhir'], $item['update_oleh']];
					}
