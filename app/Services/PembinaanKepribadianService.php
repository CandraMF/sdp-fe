		...
		class PembinaanKepribadianService
		{
			...
			private function mapping(object $data)
			{
				...
				foreach ($pembinaan_kepribadian as $val) {
					$result[] = array(
						 'id_pembinaan_kepribadian' => $val['id_pembinaan_kepribadian'],  'nama_program' => $val['nama_program'],  'jnskegiatan' => $val['jnskegiatan'],  'tempat_pelaksanaan' => $val['tempat_pelaksanaan'],  'tanggal' => $val['tanggal'],  'jam_mulai' => $val['jam_mulai'],  'jam_selesai ' => $val['jam_selesai '],  'status  ' => $val['status  ']
					);
				}
			...
			public function search(array $data, $url = null)
			{
				...
				$defaultColumn = ['pembinaan_kepribadian.id_pembinaan_kepribadian', 'pembinaan_kepribadian.nama_program', 'daftar_referensi.groups as jnskegiatan', 'pembinaan_kepribadian.tempat_pelaksanaan', 'jadwal_pembinaan_kepribadian.tanggal', 'jadwal_pembinaan_kepribadian.jam_mulai', 'jadwal_pembinaan_kepribadian.jam_selesai', 'pembinaan_kepribadian.status'];
				...
				$q = $q->join('jadwal_pembinaan_kepribadian', 'pembinaan_kepribadian.id_pembinaan_kepribadian', '=', 'jadwal_pembinaan_kepribadian.id_pembinaan_kepribadian');
			...
			public function printPDF($data)
			{
				...
				$columnOfValues = ['pembinaan_kepribadian.id_pembinaan_kepribadian', 'pembinaan_kepribadian.nama_program', 'daftar_referensi.groups as jnskegiatan', 'pembinaan_kepribadian.tempat_pelaksanaan', 'jadwal_pembinaan_kepribadian.tanggal', 'jadwal_pembinaan_kepribadian.jam_mulai', 'jadwal_pembinaan_kepribadian.jam_selesai', 'pembinaan_kepribadian.status'];
				...
				$sizeCells = ['nama_program' => 1000, 'jnskegiatan' => 1000, 'tempat_pelaksanaan' => 1000, 'tanggal' => 1000, 'jam_mulai' => 1000, 'jam_selesai ' => 1000, 'status  ' => 1000];
