		...
		class PrasaranaRuangService
		{
			...
			private function mapping(object $data)
			{
				...
				foreach ($prasarana_ruang as $val) {
					$result[] = array(
						 'id_prasarana_ruang' => $val['id_prasarana_ruang'],  'jenis_prasarana' => $val['jenis_prasarana'],  'nama_prasarana_ruang' => $val['nama_prasarana_ruang'],  'nmupt' => $val['nmupt'],  'tgl_pengadaan' => $val['tgl_pengadaan'],  'keterangan' => $val['keterangan'],  'update_terakhir' => $val['update_terakhir'],  'update_oleh' => $val['update_oleh']
					);
				}
			...
			public function search(array $data, $url = null)
			{
				...
				$defaultColumn = ['prasarana_ruang.id_prasarana_ruang', 'daftar_referensi.deskripsi as jenis_prasarana', 'prasarana_ruang.nama_prasarana_ruang', 'upt.uraian as nmupt', 'prasarana_ruang.tgl_pengadaan', 'prasarana_ruang.keterangan', 'prasarana_ruang.update_terakhir', 'prasarana_ruang.update_oleh'];
			...
			{
				$data = array(
					'id_prasarana_ruang' => $prasarana_ruang->id_prasarana_ruang, 'jenis_prasarana' => $prasarana_ruang->jenis_prasarana, 'nama_prasarana_ruang' => $prasarana_ruang->nama_prasarana_ruang, 'nmupt' => $prasarana_ruang->nmupt, 'tgl_pengadaan' => $prasarana_ruang->tgl_pengadaan, 'keterangan' => $prasarana_ruang->keterangan, 'update_terakhir' => $prasarana_ruang->update_terakhir, 'update_oleh' => $prasarana_ruang->update_oleh
				);
				return $data;
			}
			...
			public function printPDF($data)
			{
				...
				$columnOfValues = ['prasarana_ruang.id_prasarana_ruang', 'daftar_referensi.deskripsi as jenis_prasarana', 'prasarana_ruang.nama_prasarana_ruang', 'upt.uraian as nmupt', 'prasarana_ruang.tgl_pengadaan', 'prasarana_ruang.keterangan', 'prasarana_ruang.update_terakhir', 'prasarana_ruang.update_oleh'];
				...
				$sizeCells = ['jenis_prasarana' => 1000, 'nama_prasarana_ruang' => 1000, 'nmupt' => 1000, 'tgl_pengadaan' => 1000, 'keterangan' => 1000, 'update_terakhir' => 1000, 'update_oleh' => 1000];
