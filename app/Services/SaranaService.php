...
class SaranaService
{
	...
	public function search(array $data, $url = null)
	{
		...
		$defaultColumn = ['sarana.id', 'sarana.nama_sarana', 'daftar_referensi.deskripsi as jenis_sarana', 'upt.uraian as nmupt', 'sarana.tgl_pengadaan'];
		$q = Sarana::query();
	...
	public function printPDF($data)
	{
		...
		$judul = 'Sarana';
		$columns = ["Nama Sarana", "Jenis Sarana", "UPT", "Tgl Pengadaan"];

		$columnOfValues = ['sarana.id', 'sarana.nama_sarana', 'daftar_referensi.deskripsi as jenis_sarana', 'upt.uraian as nmupt', 'sarana.tgl_pengadaan'];
		$sizeCellcolumns = ["Nama Sarana" => 1000, "Jenis Sarana" => 1000, "UPT" => 1000, "Tgl Pengadaan" => 1000];
		$sizeCells = [
			'nama_sarana' => 1000,
			'jenis_sarana' => 1000,
			'nmupt' => 1000,
