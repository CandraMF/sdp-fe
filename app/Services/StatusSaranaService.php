		...
		class StatusSaranaService
		{
			...
			private function mapping(object $data)
			{
				...
				foreach ($status_sarana as $val) {
					$result[] = array(
						 'id_status_sarana' => $val['id_status_sarana'],  'nama_sarana' => $val['nama_sarana'],  'status' => $val['status'],  'kepemilkan' => $val['kepemilkan'],  'jumlah' => $val['jumlah'],  'kondisi_baik' => $val['kondisi_baik'],  'kondisi_rusak' => $val['kondisi_rusak'],  'foto' => $val['foto']
					);
				}
			...
			{
				$data = array(
					'id_status_sarana' => $status_sarana->id_status_sarana, 'nama_sarana' => $status_sarana->nama_sarana, 'status' => $status_sarana->status, 'kepemilkan' => $status_sarana->kepemilkan, 'jumlah' => $status_sarana->jumlah, 'kondisi_baik' => $status_sarana->kondisi_baik, 'kondisi_rusak' => $status_sarana->kondisi_rusak, 'foto' => $status_sarana->foto
				);
				return $data;
			}
