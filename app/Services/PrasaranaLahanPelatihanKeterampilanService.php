...
class PrasaranaLahanPelatihanKeterampilanService
{
    ...
    {
        $prasarana_lahan_pelatihan_keterampilan = $data->get()->toArray();
        if (empty($prasarana_lahan_pelatihan_keterampilan)) {
            return [];
        }
        foreach ($prasarana_lahan_pelatihan_keterampilan as $val) {
            $result[] = array(
                'id' => $val['id'],
    ...
    public function search(array $data, $url = null)
    {
        ...
        $defaultColumn = ["id", "id_prasarana_lahan", "id_pelatihan_keterampilan", "updated_at", "updated_by"];
        $q = PrasaranaLahanPelatihanKeterampilan::query();
     ...
     * Mapping details
     * 
     * @param object $prasarana_lahan_pelatihan_keterampilan
     * @return mixed
     */
    public function show(object $prasarana_lahan_pelatihan_keterampilan)
    {
        $data = array(
            'id' => $prasarana_lahan_pelatihan_keterampilan->id,
            'id_prasarana_lahan' => $prasarana_lahan_pelatihan_keterampilan->id_prasarana_lahan,
            'id_pelatihan_keterampilan' => $prasarana_lahan_pelatihan_keterampilan->id_pelatihan_keterampilan,
            'updated_at' => $prasarana_lahan_pelatihan_keterampilan->updated_at,
            'updated_by' => $prasarana_lahan_pelatihan_keterampilan->updated_by,
        );
        return $data;
    }
}
