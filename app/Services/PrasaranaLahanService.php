...
class PrasaranaLahanService
{
	...
	public function search(array $data, $url = null)
	{
		...
		$defaultColumn = ['prasarana_lahan.id', 'daftar_referensi.deskripsi as jenis_prasarana', 'prasarana_lahan.nama_prasarana_lahan', 'upt.uraian as nmupt', 'prasarana_lahan.tgl_pengadaan', 'prasarana_lahan.keterangan'];
	...
	public function printPDF($data)
	{
		...
		$columnOfValues = ['prasarana_lahan.id', 'daftar_referensi.deskripsi as jenis_prasarana', 'prasarana_lahan.nama_prasarana_lahan', 'upt.uraian as nmupt', 'prasarana_lahan.tgl_pengadaan', 'prasarana_lahan.keterangan'];
