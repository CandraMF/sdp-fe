...
class SaranaPembinaanKepribadianService
{
    ...
    {
        $sarana_pembinaan_kepribadian = $data->get()->toArray();
        if (empty($sarana_pembinaan_kepribadian)) {
            return [];
        }
        foreach ($sarana_pembinaan_kepribadian as $val) {
            $result[] = array(
                'id' => $val['id'],
    ...
    public function search(array $data, $url = null)
    {
        ...
        $defaultColumn = ["id", "id_sarana", "id_pembinaan_kepribadian", "updated_at", "updated_by"];
        $q = SaranaPembinaanKepribadian::query();
     ...
     * Mapping details
     * 
     * @param object $sarana_pembinaan_kepribadian
     * @return mixed
     */
    public function show(object $sarana_pembinaan_kepribadian)
    {
        $data = array(
            'id' => $sarana_pembinaan_kepribadian->id,
            'id_sarana' => $sarana_pembinaan_kepribadian->id_sarana,
            'id_pembinaan_kepribadian' => $sarana_pembinaan_kepribadian->id_pembinaan_kepribadian,
            'updated_at' => $sarana_pembinaan_kepribadian->updated_at,
            'updated_by' => $sarana_pembinaan_kepribadian->updated_by,
        );
        return $data;
    }
}
