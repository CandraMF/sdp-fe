...
class InstrukturPelatihanKeterampilanService
{
    ...
    {
        $instruktur_pelatihan_keterampilan = $data->get()->toArray();
        if (empty($instruktur_pelatihan_keterampilan)) {
            return [];
        }
        foreach ($instruktur_pelatihan_keterampilan as $val) {
            $result[] = array(
                'id' => $val['id'],
    ...
    public function search(array $data, $url = null)
    {
        ...
        $defaultColumn = ["id", "id_instruktur", "id_pelatihan_keterampilan", "updated_at", "updated_by"];
        $q = InstrukturPelatihanKeterampilan::query();
     ...
     * Mapping details
     * 
     * @param object $instruktur_pelatihan_keterampilan
     * @return mixed
     */
    public function show(object $instruktur_pelatihan_keterampilan)
    {
        $data = array(
            'id' => $instruktur_pelatihan_keterampilan->id,
            'id_instruktur' => $instruktur_pelatihan_keterampilan->id_instruktur,
            'id_pelatihan_keterampilan' => $instruktur_pelatihan_keterampilan->id_pelatihan_keterampilan,
            'updated_at' => $instruktur_pelatihan_keterampilan->updated_at,
            'updated_by' => $instruktur_pelatihan_keterampilan->updated_by,
        );
        return $data;
    }
}
