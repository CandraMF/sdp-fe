...
class SaranaPelatihanKeterampilanService
{
    ...
    {
        $sarana_pelatihan_keterampilan = $data->get()->toArray();
        if (empty($sarana_pelatihan_keterampilan)) {
            return [];
        }
        foreach ($sarana_pelatihan_keterampilan as $val) {
            $result[] = array(
                'id' => $val['id'],
    ...
    public function search(array $data, $url = null)
    {
        ...
        $defaultColumn = ["id", "id_sarana", "id_pelatihan_keterampilan", "updated_at", "updated_by"];
        $q = SaranaPelatihanKeterampilan::query();
     ...
     * Mapping details
     * 
     * @param object $sarana_pelatihan_keterampilan
     * @return mixed
     */
    public function show(object $sarana_pelatihan_keterampilan)
    {
        $data = array(
            'id' => $sarana_pelatihan_keterampilan->id,
            'id_sarana' => $sarana_pelatihan_keterampilan->id_sarana,
            'id_pelatihan_keterampilan' => $sarana_pelatihan_keterampilan->id_pelatihan_keterampilan,
            'updated_at' => $sarana_pelatihan_keterampilan->updated_at,
            'updated_by' => $sarana_pelatihan_keterampilan->updated_by,
        );
        return $data;
    }
}
