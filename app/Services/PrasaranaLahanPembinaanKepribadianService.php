...
class PrasaranaLahanPembinaanKepribadianService
{
    ...
    {
        $prasarana_lahan_pembinaan_kepribadian = $data->get()->toArray();
        if (empty($prasarana_lahan_pembinaan_kepribadian)) {
            return [];
        }
        foreach ($prasarana_lahan_pembinaan_kepribadian as $val) {
            $result[] = array(
                'id' => $val['id'],
    ...
    public function search(array $data, $url = null)
    {
        ...
        $defaultColumn = ["id", "id_prasarana_lahan", "id_pembinaan_kepribadian", "updated_at", "updated_by"];
        $q = PrasaranaLahanPembinaanKepribadian::query();
     ...
     * Mapping details
     * 
     * @param object $prasarana_lahan_pembinaan_kepribadian
     * @return mixed
     */
    public function show(object $prasarana_lahan_pembinaan_kepribadian)
    {
        $data = array(
            'id' => $prasarana_lahan_pembinaan_kepribadian->id,
            'id_prasarana_lahan' => $prasarana_lahan_pembinaan_kepribadian->id_prasarana_lahan,
            'id_pembinaan_kepribadian' => $prasarana_lahan_pembinaan_kepribadian->id_pembinaan_kepribadian,
            'updated_at' => $prasarana_lahan_pembinaan_kepribadian->updated_at,
            'updated_by' => $prasarana_lahan_pembinaan_kepribadian->updated_by,
        );
        return $data;
    }
}
